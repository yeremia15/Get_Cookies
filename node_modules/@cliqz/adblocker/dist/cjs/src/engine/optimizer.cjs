...
var domains = require('./domains.cjs');
...
const OPTIMIZATIONS = [
    ...
    },
    {
        ...
        fusion: (filters) => {
            ...
            return new network.default(Object.assign({}, filters[0], {
                domains: new domains.Domains({
    ...
    },
    {
        ...
        fusion: (filters) => {
            ...
            return new network.default(Object.assign({}, filters[0], {
                mask: utils.setBit(filters[0].mask, 8388608 /* NETWORK_FILTER_MASK.isRegex */),
                rawLine: filters[0].rawLine !== undefined
                    ? filters.map(({ rawLine }) => rawLine).join(' <+> ')
                    : undefined,
