...
function tokenizeNoSkip(pattern) {
    ...
    tokenizeNoSkipInPlace(pattern, tokensBuffer.TOKENS_BUFFER);
    return tokensBuffer.TOKENS_BUFFER.slice();
}
function tokenize(pattern, skipFirstToken, skipLastToken) {
    tokensBuffer.TOKENS_BUFFER.reset();
    tokenizeInPlace(pattern, skipFirstToken, skipLastToken, tokensBuffer.TOKENS_BUFFER);
    return tokensBuffer.TOKENS_BUFFER.slice();
}
...
exports.HASH_INTERNAL_MULT = HASH_INTERNAL_MULT;
