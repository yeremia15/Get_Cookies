 ...
 */
function generateDiff(prevRevision, newRevision, config = new Config()) {
    // Set config to `debug` so that we keep track of raw lines for each filter
...
export { detectFilterType, f, generateDiff, getLinesWithFilters, mergeDiffs, parseFilter, parseFilters };
