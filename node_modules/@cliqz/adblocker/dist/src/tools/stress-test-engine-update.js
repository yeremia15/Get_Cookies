...
import { Config, FiltersEngine, generateDiff, getLinesWithFilters, parseFilter, } from '../adblocker';
...
async function run() {
    for (const list of [
        ...
        for (const { previousRevision, currentRevision, currentList, previousList } of testCases) {
            ...
            const filtersFromCurrentEngine = getFiltersFromEngine(FiltersEngine.deserialize(currentEngineSerialized));
...
run();
//# sourceMappingURL=stress-test-engine-update.js.map