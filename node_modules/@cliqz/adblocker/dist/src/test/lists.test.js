...
describe('#parseFilters', () => {
    ...
    it('ignores preprocessors', () => {
        const result = parseFilters(`!#if true
    ||foo.com
!#endif`);
...
||foo.com
    ...
    it('handle filter renaming', () => {
        expect(generateDiff('||foo.com$domain=foo.com|bar.com', '||foo.com$domain=bar.com|foo.com')).to.eql({
            added: [],
            removed: [],
            preprocessors: {},
        });
...
!#endif`, config)).to.eql({
        ...
        expect(generateDiff(`||foo.com^`, `!#if true
||foo.com^
!#endif`, config)).to.eql({
            added: [],
            removed: [],
