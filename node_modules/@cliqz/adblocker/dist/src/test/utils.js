...
export function loadEasyListFilters() {
...
export function typedArrayDiff(arr1, arr2) {
    const differences = [];
...
export function typedArrayEqual(arr1, arr2) {
