...
describe('preprocessors', () => {
    ...
    const doTest = (filters, thisEnv = env) => {
        ...
        expect(engine1.match(requests.foo), customErrorMessage(requests.foo, filters, thisEnv)).to.have.property('match', true);
        expect(engine1.match(requests.bar), customErrorMessage(requests.bar, filters, thisEnv)).to.have.property('match', false);
        ...
        expect(engine2.match(requests.foo), customErrorMessage(requests.foo, filters, thisEnv)).to.have.property('match', true);
        expect(engine2.match(requests.bar), customErrorMessage(requests.bar, filters, thisEnv)).to.have.property('match', false);
    };
