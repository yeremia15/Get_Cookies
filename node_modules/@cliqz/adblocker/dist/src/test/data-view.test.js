...
describe('#StaticDataView', () => {
    ...
    describe('#getUint32ArrayView', () => {
        ...
        it('serialize/deserialize', () => {
            ...
            expect(cropped).to.eql(new Uint8Array([1, 0, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0, 255, 255, 255, 255, 3, 0, 0, 0]));
            // Reload
            const newView = StaticDataView.fromUint8Array(cropped, { enableCompression: false });
            expect(newView.getBool()).to.be.true;
            expect(newView.getUint32ArrayView(4)).to.eql(new Uint32Array([1, 2, Number.MAX_SAFE_INTEGER >>> 0, 3]));
        });
    });
});
