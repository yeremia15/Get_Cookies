...
import { HASH_SEED, binLookup, binSearch, fastHash, fastHashBetween, hasUnicode, tokenize, tokenizeInPlace, tokenizeNoSkip, tokenizeNoSkipInPlace, tokenizeWithWildcards, tokenizeWithWildcardsInPlace, } from '../src/utils';
...
describe('utils.ts', () => {
    ...
    describe('#fastHash', () => {
        it('does not produce collision on network filters', () => {
            checkCollisions(parseFilters(allLists, {
